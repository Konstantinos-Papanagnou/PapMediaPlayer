...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PapMediaPlayer.Details, PapMediaPlayer", Details.class, __md_methods);
	}
	...
	public Details ()
	{
		...
		if (getClass () == Details.class)
			mono.android.TypeManager.Activate ("PapMediaPlayer.Details, PapMediaPlayer", "", this, new java.lang.Object[] {  });
	}
